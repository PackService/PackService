...
struct PersonAgreeDescriptView: View {
    ...
    let personAgreeContent = PersonAgreeContent()
        ...
        HStack {
            VStack(alignment: .leading, spacing: 10) {
                HStack {
                    ...
                    Text("나의택배앱 개인정보 처리 방침")
                }
                ScrollView {
                    HStack {
                        Text("스마트택배 개인정보 처리방침 ㈜써머스플랫폼(이하 ‘회사’)는 홈페이지,이메일,API,스마트폰 어플리케이션등의 방법으로 수집 및 이용 목적에 따라 필요한 최소한의 고객정보를 수집하고 이용합니다. 수집하는 개인정보 항목과 수집 및 이용 목적은 다음과 같습니다.")
                    ...
                    ForEach((0...13), id: \.self) {index in
                        VStack {
                            HStack {
                                Text(personAgreeContent.title[index])
                                    .font(FontManager.title3)
                                Spacer()
                            }

                            HStack {
                                Text(personAgreeContent.content[index])
                                    .font(FontManager.body2)
                                Spacer()
                            }
                        }
