            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                ScrollView {
                    ForEach((0...17), id: \.self) {index in
                        VStack {
                            HStack {
                                Text(termsOfService.title[index])
                                    .font(FontManager.title3)
                                Spacer()
                            }
                            
                            HStack {
                                Text(termsOfService.content[index])
...
//MARK: - NavigationTermsOfServiceView
struct NavigationTermsOfServiceView: View {
