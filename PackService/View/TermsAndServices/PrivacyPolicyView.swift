        ...
        HStack {
            VStack(alignment: .leading, spacing: 10) {
                HStack {
                    ...
                    Text("이지택배 개인정보 처리 방침")
                        .bold()
                }
                ScrollView {
                    HStack {
                        Text("이지택배 개인정보 처리방침 회사는 홈페이지,이메일,API,스마트폰 어플리케이션등의 방법으로 수집 및 이용 목적에 따라 필요한 최소한의 고객정보를 수집하고 이용합니다. 수집하는 개인정보 항목과 수집 및 이용 목적은 다음과 같습니다.")
